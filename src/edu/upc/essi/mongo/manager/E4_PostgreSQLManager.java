...
public class E4_PostgreSQLManager {
	...
	public static E4_PostgreSQLManager getInstance(String table, int attributes, JsonObject JSONSchema, CSVWriter writer) throws Exception {
		if (instance == null)
			instance = new E4_PostgreSQLManager(table, attributes, JSONSchema, writer);
		return instance;
	}

	public E4_PostgreSQLManager(String table, int attributes, JsonObject JSONSchema, CSVWriter writer2) throws Exception {
		this.table = table;
